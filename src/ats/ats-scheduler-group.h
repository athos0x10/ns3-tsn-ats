...
namespace ns3
{
    ...
    public:
        ...
        /**
         * \brief Ergonomic function to bind a stream to an existing ATS instance for ES.
         *
         * \param vlanId The vlan id of the stream.
         * \param destMac The destination mac adress of the stream.
         * \param instanceId The id of the ATS instance.
         * \return True if the binding succeeded.
         */
        bool BindStreamToInstanceES(Mac48Address destMac, uint16_t vlanId, uint32_t instanceId);
         ...
         */
        bool ProcessFrame(Ptr<Packet> packet, Time hardwareLatency, uint32_t streamHandle);
    ...
    private:
        ...
        // Map linking each unique stream handle id to its corresponding ATS Scheduler Instance
