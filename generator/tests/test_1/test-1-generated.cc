...
NS_LOG_COMPONENT_DEFINE ("Test_1_generated");

int main(int argc, char* argv[])
{
  // --- Logging and Tracing Configuration ---
  LogComponentEnable("Test_1_generated", LOG_LEVEL_INFO);

  // -------------------------------------------------------------
  // --- Topology Auto-Generated from topology.json ---
  // -------------------------------------------------------------
  ...
  // Allocate a Mac address and create a FIFO for each netDevice
  // --- Switch Ports Vector for Automation ---
  std::vector<Ptr<TsnNetDevice>> sw_ports = {
      sw0_p0, sw0_p1, sw0_p2, sw0_p3, sw0_p6, sw0_p7, sw1_p0, sw1_p2, sw1_p3, sw1_p6, sw1_p7, sw2_p2, sw2_p3, sw3_p2, sw3_p3, sw3_p6};
  ...
  // -------------------------------------------------------------
  // --- Routes Auto-Generated from routes.json ---
  // -------------------------------------------------------------

  // FLOW 0 (ES7 -> ES2, ES3, ES6)
  ...
  sw0->AddForwardingTableEntry(esMacs[4], 1, std::vector<Ptr<NetDevice>>{sw0_p0});
  // -------------------------------------------------------------
  // --- Streams Auto-Generated from streams.json ---
  // -------------------------------------------------------------
  ...
  // ==========================================
  // STREAM0 (Source: ES7 -> Dest: ES3, ES6, ES2)
  // ISOCHRONOUS, PCP: 7, Size: 58B, Period: 1000us
  // ==========================================
  std::vector<int> stream0_dests = {3, 6, 2};
  ...
  for (int dest_idx : stream3_dests)
  {
      ...
      app3->SetAttribute("Period", TimeValue(Seconds(1)));
  ...
  // ==========================================
  // STREAM4 (Source: ES6 -> Dest: ES3, ES0, ES4)
  // BEST-EFFORT, PCP: 0, Size: 1500B, Period: null (Continuous/Asynchronous)
  // ==========================================
  std::vector<int> stream4_dests = {3, 0, 4};
  for (int dest_idx : stream4_dests)
  {
      ...
      app4->SetAttribute("Period", TimeValue(Seconds(1)));
  ...
  // Start all traffic applications
